...
export class PaginatorStyleDirective implements AfterViewInit, OnChanges {
  /**
  ...
  private createBubbleDivRef(): void {
    ...
    this.ren.setStyle(this.bubbleContainerRef,'gap', '4px');
  ...
  private createButton(i: number): HTMLElement {
    ...
    // add class & text
    this.ren.setStyle(bubbleButton, 'width', '34px')
    this.ren.setStyle(bubbleButton, 'width', '34px')
    this.ren.setStyle(bubbleButton, 'display', 'flex')
    this.ren.setStyle(bubbleButton, 'align-items', 'center')
    this.ren.setStyle(bubbleButton, 'justify-content', 'center')
    this.ren.setStyle(bubbleButton, 'font-size', '14px')

    this.ren.setStyle(bubbleButton, 'margin-right', '8px')
    this.ren.setStyle(bubbleButton, 'border', 0);
    this.ren.setStyle(bubbleButton,'border-radius','50%');

    this.ren.addClass(bubbleButton,'mat-mdc-raised-button');
    this.ren.addClass(bubbleButton,'mat-primary');
