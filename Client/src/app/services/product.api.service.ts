...
export class ProductApiService extends ApiBase {
   ...
   */
  getPricesHistoryForProduct(productId: string, pageNumber?: number | undefined, pageSize?: number | undefined, minPrice?: number | null | undefined, maxPrice?: number | null | undefined, startDate?: Date | null | undefined, endDate?: Date | null | undefined): Observable<PriceHistoryDto[]> {
    let url_ = this.baseUrl + "/api/products/{productId}/pricesHistory?";
  ...
  getPriceHistoryForProduct(productId: string, priceHistoryId: string): Observable<PriceHistoryDto> {
    let url_ = this.baseUrl + "/api/products/{productId}/pricesHistory/{priceHistoryId}";
    if (productId === undefined || productId === null)
      throw new Error("The parameter 'productId' must be defined.");
    url_ = url_.replace("{productId}", encodeURIComponent("" + productId));
   ...
   */
  getProductsForCategory(categoryId: string, pageNumber?: number | undefined, pageSize?: number | undefined, maxPrice?: number | null | undefined, minPrice?: number | null | undefined, searchTerm?: string | null | undefined, fields?: string | null | undefined): Observable<ProductDto[]> {
   ...
   */
  getReviewsForProduct(productId: string, pageNumber?: number | undefined, pageSize?: number | undefined, rating?: number | null | undefined, startDate?: Date | null | undefined, endDate?: Date | null | undefined): Observable<ReviewDto[]> {
...
export class ProductParameters implements IProductParameters {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.fields = _data["fields"] !== undefined ? _data["fields"] : <any>null;
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data["fields"] = this.fields !== undefined ? this.fields : <any>null;
    return data;
  }
}
