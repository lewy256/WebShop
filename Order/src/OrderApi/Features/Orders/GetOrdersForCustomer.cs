...
public static class GetOrdersForCustomer {
...
public class GetOrdersEndpoint : ICarterModule {
    public void AddRoutes(IEndpointRouteBuilder app) {
        ...
        async (ISender sender, HttpContext context, [AsParameters] OrderParameters orderParameters) => {
            var query = new GetOrdersForCustomer.Query(orderParameters);
        ...
        }).WithName(nameof(GetOrdersForCustomer)).WithTags(nameof(Order));
    }
}
