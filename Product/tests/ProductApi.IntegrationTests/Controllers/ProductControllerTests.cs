...
public class ProductControllerTests {
    ...
    [Fact]
    public async Task GetProducts_WithValidCategoryId_ReturnsOk() {
        ...
        expectedResponse.Should().BeEquivalentTo(response, opt => opt.Excluding(x => x.Files));
    }
    ...
    [Fact]
    public async Task GetProduct_WithValidProductId_ReturnsOk() {
